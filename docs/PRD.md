...
version: 0.4
status: fixture-first local release candidate with Kakao live connectivity verified
owner: 이수미 교수
created: 2026-07-13
updated: 2026-07-14
---
...
| 문서 버전       | 0.4                                                                |
| 상태            | fixture MVP 완료, Kakao 지도·장소 연결 검증, 경로·공개 게이트 대기 |
| 기준일          | 2026-07-14                                                         |
| 제품 책임자     | 이수미 교수                                                        |
...
- [x] Kakao Maps 개발자 앱·localhost 도메인·현재 쿼터·요금·비과금 설정 확인
